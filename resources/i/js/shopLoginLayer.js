    ...
    */    
    ...
    var loginParams = {'ZsLoginBoxType' : 1, 'ZsLoginType':1, 'ZsLoginUrl' : 'http://www.zol.com', 'ZsLoginSubmitId' : '', 'backUrl' : ''};
    ...
    ZsLogin.openLoginBox = function (){
        ...
        var boxStr  = '';
            ...
            boxStr += '<div class="form-other"><a target="_blank" href="https://login.zol.com/index.php?c=Default&a=Register" class="register-btn">立即注册</a></div>'; 
